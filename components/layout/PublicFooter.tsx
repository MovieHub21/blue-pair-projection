      ...
      <div className="container-w px-6 md:px-10">
        <div className="grid md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-xs">Uromi's premium address for stays, dining and events — where luxury hospitality meets Edo State warmth.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5 text-sm">
              <Link href="/account/login" className="hover:text-white">Manage booking</Link>
              ...
              <Link href="/parking" className="hover:text-white">Parking</Link>
            </div>
          </div>
          <div>
