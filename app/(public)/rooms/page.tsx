...
export const metadata=buildMetadata({title:'Hotel Rooms & Suites in Uromi, Edo State | Prices & Online Booking',description:'Browse Blue Pair Hotel rooms and suites in Uromi, Edo State. See live room availability, guest capacity and book online.',keywords:'hotel rooms uromi, book hotel room edo state, uromi hotel rooms, hotel room prices uromi',path:'/rooms'})
