      ...
      <header className="relative bg-cream-50 pb-14 pt-6 md:pb-20 md:pt-10">
        <div className="w-full px-5 md:px-10">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <div className="motion-fade-up relative aspect-[4/4] max-h-[420px] overflow-hidden rounded-xl bg-navy-950 shadow-pop md:aspect-[20/16] md:max-h-[480px] lg:max-h-[520px]" style={{ animationDelay: '480ms', animationDuration: '550ms' }}>
