...
export default function HomeClient({ roomTypes, offers, gallery, headline, subtitle }: { roomTypes: RoomType[]; offers: Offer[]; gallery: GalleryImage[]; headline?: string; subtitle?: string }) {
  ...
  return (
    <div>
      <header className="relative min-h-[520px] h-[72vh] md:min-h-[720px] md:h-[88vh] max-h-[900px] text-white overflow-hidden">
        ...
        <div className="relative z-10 container-w px-5 md:px-10 h-full flex items-center md:items-end pb-10 md:pb-32 pt-20 md:pt-0">
          <div className="max-w-3xl">
            ...
            <h1 className="text-[2.2rem] sm:text-5xl md:text-6xl lg:text-[4.6rem] font-semibold leading-[1.02] tracking-[-0.035em] max-w-3xl">
              {headline || <>Welcome to <em className="italic text-gold-300 font-medium">Blue Pair.</em></>}
            </h1>
            <p className="mt-4 md:mt-6 max-w-2xl text-sm md:text-lg text-white/85 leading-relaxed">
            ...
            <div className="mt-5 md:mt-8 flex flex-wrap items-center gap-x-5 md:gap-x-6 gap-y-2 text-[11px] md:text-xs text-white/65">
