...
export const metadata = buildMetadata({
  ...
  keywords: 'Blue Pair Signature Crown Hotel & Suites, Blue Pair Signature Crown, luxury hotel Uromi, hotel Edo State, hotel history Uromi, hospitality Uromi',
  path: '/about',
})
    ...
    <div>
      ...
      <section className="section bg-navy-950 text-white">
        <div className="container-w">
          <SectionHeading eyebrow="Hospitality philosophy" title="What guests can expect" light center subtitle="Four principles that shape every department at Blue Pair Signature Crown Hotel & Suites." />
