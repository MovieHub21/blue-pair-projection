...
export default function RoomManagement(){
  ...
  function startEditUnit(typeId:string,r:Unit){setEditingUnit(r.id);setUnitModal(typeId);setUnit({number:r.room_number,floor:r.floor,name:r.name,images:Array.from(new Set([...(r.images||[]),r.image_url].filter(Boolean) as string[]))});setMessage(null)}
  ...
  async function saveUnit(){
    ...
    const images=Array.from(new Set(unit.images.filter(Boolean)))
    setBusy(true);setMessage(null)
