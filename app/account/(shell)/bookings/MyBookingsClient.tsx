    ...
    <div className="grid gap-4">
      {bookings.map(b => {
        ...
        return <div key={b.id} className="card p-5 flex flex-col sm:flex-row gap-4 sm:items-center">
          {b.room?.images?.[0] && <img loading="lazy" decoding="async" src={b.room.images[0]} alt={b.room.name} className="w-full sm:w-28 h-28 rounded-xl object-cover" />}
