...
type RoomOrder = { id: string; reference: string; room: string; items: CartItem[]; notes: string; total: number; payment_status: string; status: string; created_at: string }
