...
export const MANAGEMENT_GROUPS: PortalNavGroup[] = [
  ...
  { label: 'Outlets', items: [
    ...
    { href: '/admin/restaurant/orders', label: 'Room-service Orders', icon: <ShoppingBag size={16} /> }, 
  ...
  { label: 'Content', items: [{ href: '/admin/gallery', label: 'Gallery', icon: <Image size={16} /> }, 
  ...
  { label: 'Front Desk', items: [{ href: '/admin/reception/dashboard', label: 'Reception Dashboard', icon: <LayoutGrid size={16} />, end: true }, 
    { href: '/admin/reception/arrivals', label: "Today's Arrivals", icon: <LogIn size={16} /> }, 
    { href: '/admin/reception/departures', label: "Today's Departures", icon: <LogOut size={16} /> }, 
    { href: '/admin/reception/room-assignment', label: 'Room Assignment', icon: <BedDouble size={16} /> },
     { href: '/admin/reception/requests', label: 'Guest Requests', icon: <MessageSquare size={16} /> }, 
     { href: '/admin/reception/room-service', label: 'Room-service Tracking', icon: <ShoppingBag size={16} /> }, 
     { href: '/admin/contact-messages', label: 'Guest Messages', icon: <MessageSquare size={16} /> }] },
  { label: 'Housekeeping', items: [{ href: '/admin/housekeeping/dashboard', label: 'Housekeeping Dashboard', icon: <Sparkles size={16} />, end: true }, 
    { href: '/admin/housekeeping/tasks', label: 'Cleaning Tasks', icon: <ClipboardList size={16} /> }] },
  { label: 'Maintenance', items: [{ href: '/admin/maintenance/dashboard', label: 'Maintenance Dashboard', icon: <Wrench size={16} />, end: true },
     { href: '/admin/maintenance/tickets', label: 'Tickets', icon: <Wrench size={16} /> }] },
]
